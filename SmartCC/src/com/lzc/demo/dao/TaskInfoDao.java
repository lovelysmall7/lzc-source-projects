...
public class TaskInfoDao extends BaseDao<TaskInfo>{
	...
	public List<TaskInfo> findCurrentNotFinishList(){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		List<TaskInfo> list = session.selectList(sqlNameSpace + "." + "findCurrentNotFinishList");
		session.close();
		return list;
	}
	public List<HashMap<String,Object>> ExportTaskInfo(TaskInfo t){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		List<HashMap<String,Object>> list = session.selectList(sqlNameSpace + "." + "ExportTaskInfo",t);
		session.close();
		return list;
	}
	public TaskInfoDao(){
	 ...
	 * @return
	 */
	public List<HashMap<String,Object>> getStationByComponent(String componentName){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		List<HashMap<String,Object>> list = session.selectList(sqlNameSpace + "." + "getStationByComponent",componentName);
		session.close();
		return list;
	}
	/**
	...
	public List<TaskInfo> findUnfinishOnCurrentDay(TaskInfo t){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		List<TaskInfo> list = session.selectList(sqlNameSpace + "." + "findUnfinishOnCurrentDay",t);
		session.close();
		return list;
	}
	public List<HashMap<String,Object>> selectBatchNos(){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		List<HashMap<String,Object>> list = session.selectList(sqlNameSpace + "." + "selectBatchNos");
		session.close();
		return list;
	}
	public Integer selectCurrentComponentNum(){
		SqlSession session = SqlMapInitUtil.getSqlSession();
		Integer num = session.selectOne(sqlNameSpace + "." + "selectCurrentComponentNum");
		session.close();
		return num;
	}
}
