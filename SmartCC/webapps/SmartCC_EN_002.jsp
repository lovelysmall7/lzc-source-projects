...
//分配人员提交按钮响应
	...
	<style>
		...
		*{margin:0;padding:0;list-style-type:none ;}
		...
		.demo .action{color:#3366cc;text-decoration:none;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;;}
	...
	<div id="dlg-buttons">
		<a href="javascript:void(0)" class="easyui-linkbutton  button blue"
			data-options="iconCls:'icon-ok'" onclick="addEmergency()" style="width:90px">OK</a> <a
									...
									<tr>
										...
										<td class = "layoutTable" style="width: 35.7%;">
											...
											<div style="margin-bottom:0.5%;height:9%;">
												...
												<select autocomplete="off" id="searchState"  name="dept" style="width:13%;height: 28px;">
