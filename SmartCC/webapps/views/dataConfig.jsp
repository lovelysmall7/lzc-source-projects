...
<html>
  <head>
	...
	function saveGroupInfo(){
		...
		$(document).ready(function(){
			...
			$('#workerTable').datagrid({
				...
				columns:[[
					...
					{field:'edit',align:'center',title:'Operation',width:300,formatter:EditWorkerFormat}
				]]
			});
			...
			$('#areaTable').datagrid({
				...
				columns:[[
					...
					{field:'createTimeStr',align:'center',title:'Creation time',width:300},
					{field:'edit',align:'center',title:'Operation',width:300,formatter:EditAreaFormat}
			...
			$('#groupTable').datagrid({
				...
				columns:[[
					{field:'groupName',align:'center',title:'Group name',width:300},
					{field:'createTimeStr',align:'center',title:'Creation time',width:300},
					{field:'edit',align:'center',title:'Operation',width:300,formatter:EditGroupFormat}
		...
		{  
    	 	return '<a href="javascript:void(0)"  value="" onclick="EditWorkerForward('+index+')">Edit</a> &nbsp;' + 
    	 	' <a href="javascript:void(0)"  value="" onclick="deleteWorker('+index+')">Delete</a>';  
		}
		function EditAreaFormat(val, row, index)   
		{  
    	 	return ' <a href="javascript:void(0)"  value="" onclick="deleteArea('+index+')">Delete</a>';  
		}
		function EditGroupFormat(val, row, index)   
		{  
    	 	return ' <a href="javascript:void(0)"  value="" onclick="deleteGroup('+index+')">Delete</a>';  
		}
		function deleteGroup(index){
			$.messager.confirm('Remind','Are you sure you want to delete?', function(r){
		       if(r){
					...
					<tr style="width: 100%;height: 7%;">
						<td >
							<div>
									...
									<font style="font-size: 24px;color:#333;font-weight: 500;margin-top: 5%">Area Management</font>
								</div>
						</td>
					</tr>
					<!-- 中间主体 -->
