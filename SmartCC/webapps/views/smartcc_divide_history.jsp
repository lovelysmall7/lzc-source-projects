					...
					<tr style="width: 100%;height: 5%;">
							<td colspan="2">
								<div>
									...
									<font style="font-size: 24px;color:#333;font-weight: 500;margin-top: 5%">Optimization Result</font>
								</div>
							</td>
					</tr>
					<!-- 中间表格 -->
							...
							<table align="center" id="divideHistoryTable" pagination="true"  pageSize="30"  class="easyui-datagrid"
								...
								<thead>
									<tr>
										...
										<th data-options="field:'stationIds',width:90,align:'center'">Part Stations</th>
