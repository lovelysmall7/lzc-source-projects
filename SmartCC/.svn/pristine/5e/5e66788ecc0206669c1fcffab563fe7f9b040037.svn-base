...
public class OptimizeAlgoImpl1 extends BaseOptimizeAlgo implements StartOptimizeInter{
	...
	public static void main(String[] args){
		/*OptimizeAlgoImpl1 o = new OptimizeAlgoImpl1();
		//System.out.println(o.judgeStation("170022","170166"));
		...
		aaa.add("996633");
		aaa.add("002255");
	//	aaa = o.sortComponentStations(aaa);
